      ...
      <div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 40 }}>
        <div style={{ textAlign: 'center', maxWidth: 380, color: 'var(--ink-3)' }}>
          ...
          <div style={{ fontSize: 13, marginTop: 6, lineHeight: 1.5 }}>
            El análisis del equipo lo ve el organizador de tu estudio.
          </div>
        </div>
      </div>
    );
        ...
        >
              ...
              {ranked.map((p, i) => (
                <div key={p.id}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8, flexWrap: 'wrap' }}>
                    <span className="font-mono" style={{ fontSize: 12, color: 'var(--ink-3)', width: 16 }}>
                      {i + 1}
                    </span>
                    ...
                    <div style={{ flex: '1 1 140px', minWidth: 0 }}>
                      ...
                      <div style={{ fontSize: 11.5, color: 'var(--ink-3)' }}>
                        {p.role} · {p.polizas} pólizas · {p.conversion}% conv.
                      </div>
                    </div>
                    <div className="font-mono tnum" style={{ fontSize: 13.5, fontWeight: 600, color: 'var(--ink)' }}>
                      {p.prima > 0 ? arsShort(p.prima) : '—'}
                    </div>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    <div
                      style={{
                        height: '100%',
                        width: `${(p.prima / maxPrima) * 100}%`,
                        borderRadius: 99,
                        background: i === 0 ? 'var(--orange)' : 'var(--ink-3)',
                        transition: 'width .4s',
                      }}
                    />
                  </div>
          ...
          <Panel>
            <SectionHead
              ...
              sub="Prima nueva gestionada · 6 meses"
              action={
            ...
            <div style={{ display: 'flex', alignItems: 'flex-end', gap: 14, height: 180, padding: '12px 0 0' }}>
              {prod.map((v, i) => (
                ...
                >
                  <span className="font-mono tnum" style={{ fontSize: 11, color: 'var(--ink-2)', fontWeight: 600 }}>
                    {v}M
                  </span>
                  <div
                    style={{
                      ...
                      background: i === prod.length - 1 ? 'var(--orange)' : 'var(--orange-soft2)',
            ...
            >
              ...
              <div style={{ textAlign: 'right' }}>
                ...
                <div className="font-mono tnum" style={{ fontSize: 14, fontWeight: 600 }}>
                  $ 2,9M
                </div>
              </div>
            </div>
