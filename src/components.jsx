...
function useIsMobile() {
  ...
  const compute = () =>
    typeof window.__forceMobile === 'boolean' ? window.__forceMobile : window.matchMedia(query).matches;
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      window.removeEventListener('rumbo-force-mobile', update);
    };
  }, []);
  return mobile;
}
...
function PageHead({ eyebrow, title, sub, actions, tick = 3 }) {
  ...
  return (
    ...
    >
      <div>
        <div className="tick-row" style={{ marginBottom: 10 }}>
          <Ticks n={7} active={tick} />
          <span className="eyebrow">{eyebrow}</span>
        </div>
        <h1
          className="font-display"
          style={{ fontSize: isMobile ? 26 : 34, letterSpacing: '-0.03em', color: 'var(--ink)', lineHeight: 1.04 }}
        >
          {title}
        </h1>
      ...
      {segs.map(s => (
        <button
          ...
          style={{
            ...
            fontSize: 13,
            fontWeight: 600,
            color: value === s.id ? 'var(--ink)' : 'var(--ink-3)',
            background: value === s.id ? 'var(--panel)' : 'transparent',
            boxShadow: value === s.id ? 'var(--shadow-sm)' : 'none',
            transition: 'all .14s',
            whiteSpace: 'nowrap',
            flexShrink: 0,
          }}
...
function MiniStat({ label, value, tone, small }) {
  return (
    <div style={{ background: 'var(--panel)', padding: '12px 14px' }}>
      ...
      <div
        className={small ? 'font-mono' : 'font-mono tnum'}
        style={{ fontSize: small ? 12 : 17, fontWeight: 600, color: tone || 'var(--ink)' }}
      >
        {value}
      </div>
    </div>
      ...
      >
        {NAV_GROUPS.map((group, gi) => (
          <div
            ...
            style={{ display: 'flex', flexDirection: 'column', gap: 2, marginBottom: group.label ? 8 : 4 }}
          >
            {group.label && (
              <div className="eyebrow" style={{ padding: '8px 11px 4px', fontSize: 10 }}>
                {group.label}
              </div>
            )}
          ...
          return (
            ...
            >
              ...
              <div style={{ flex: 1, lineHeight: 1.25, minWidth: 0 }}>
                ...
                >
                  {me.roleLabel}
                  {me.matricula ? ` · Matrícula ${me.matricula}` : ''}
                </div>
              </div>
            </div>
          );
    ...
    >
              ...
              <React.Fragment key={i}>
                ...
                <span
                  ...
                  style={{
                    ...
                    color: i === arr.length - 1 ? 'var(--ink)' : 'var(--ink-3)',
      ...
      {!isMobile && (
        <button
          ...
          onMouseEnter={e => {
            e.currentTarget.style.color = 'var(--red-ink)';
    ...
    >
        ...
        return (
          <button
            ...
            style={{
              ...
              justifyContent: 'center',
              gap: 3,
              color: active ? 'var(--orange-ink)' : 'var(--ink-3)',
              paddingTop: 6,
            }}
          >
      ...
      <button
        ...
        style={{
          ...
          justifyContent: 'center',
          gap: 3,
          color: moreActive ? 'var(--orange-ink)' : 'var(--ink-3)',
          paddingTop: 6,
        }}
      >
    ...
    >
      <div
        ...
        style={{
          ...
          display: 'flex',
          flexDirection: 'column',
          animation: 'rumbo-sheet .24s cubic-bezier(0.16,1,0.3,1)',
        }}
      >
        ...
        <div className="scroll" style={{ flex: 1, overflowY: 'auto', padding: '10px 18px 8px' }}>
          {NAV_GROUPS.map((group, gi) => (
            <div key={group.label || `g${gi}`} style={{ marginBottom: 10 }}>
              {group.label && (
                <div className="eyebrow" style={{ padding: '8px 4px 6px' }}>
                  {group.label}
                </div>
              )}
